...
{
    ///<summary>Used to send queries. The methods are public since it is not acceptable for the UI to be sending queries.</summary>
    public class Db
    {
        ...
        public static List<long> GetListLong(string command, bool hasExceptions = true)
        {
        ...
        public static List<string> GetListString(string command)
        {
        ...
        public static long NonQ(string[] commands)
        {
        ...
        public static int NonQ32(string command, bool getInsertID)
        {
            LastCommand = command;
        ...
        {
            return SIn.Int((GetLong(command).ToString()), false);
        }
        ...
        public static long GetLong(string command)
        {
            LastCommand = command;
            ...
            return SIn.Long(table.Rows[0][0].ToString());
        }
