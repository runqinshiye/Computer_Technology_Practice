...
namespace CodeBase
{
    ...
    public class ODThread
    {
        ...
        public static List<NamedResetEvent> QuitAsyncThreadsByGroupName(string groupName, bool doRemoveThreads = false)
        {
            ...
            { //Quit all threads in parallel so our wait times are not cummulative.
            ...
            bool doRunOnCurrentThreadIf1Processor = false, bool isLegacy = false)
        {
            ...
            {
                if (ex != null)
                { //One of the actions threw an unhandled exception.
                    if (onException == null)
                    { //No handler was provided so throw. 
