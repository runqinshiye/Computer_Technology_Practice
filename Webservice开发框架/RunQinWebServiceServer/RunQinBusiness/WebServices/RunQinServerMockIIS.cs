...
{
    public class RunQinServerMockIIS : IRunQinServer
    {
        ...
        public RunQinServerMockIIS(string server = "", string db = "", string user = "", string password = "", string userLow = "", string passLow = ""
