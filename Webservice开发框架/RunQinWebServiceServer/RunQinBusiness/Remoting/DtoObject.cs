...
namespace RunQinBusiness.Remoting
{
    ...
    {
        ///<summary>Fully qualified name, including the namespace but not the assembly.  Examples: System.Int32, RunQinBusiness.Patient, RunQinBusiness.Patient[], List&lt;RunQinBusiness.Patient&gt;, PluginOC.OcContainer.  When the xml element is created for the Obj, the namespace is not included.  So this field properly stores it.</summary>
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            if (reader.Name == "IsNull")
            {//Older versions that haven't updated to 17.3 yet may not have this element.
        ...
        ///<summary>Examples of strTypeName passed in: System.Int32, System.Drawing.Color, RunQinBusiness.Patient, RunQinBusiness.Patient[], List&lt;RunQinBusiness.Patient&gt;, PluginOC.OcContainer</summary>
        private static Type ConvertNameToType(string strTypeName)
        {
            Type typeObj = null;
            if (strTypeName == "System.Drawing.Color")
            {
            ...
            {//system types, RunQinBusiness, and plugins
                ...
                if (assemb == null)
                {
                    ...
                    if (typeObj == null)
                    {//For assemblies other than RunQinBusiness, i.e. CodeBase
