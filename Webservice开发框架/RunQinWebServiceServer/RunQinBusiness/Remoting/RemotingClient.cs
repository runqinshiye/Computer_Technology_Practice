...
using RunQinBusiness.ODEvents;
using RunQinBusiness.WebServices;
using System;
using System.Data;
using System.Net;
...
namespace RunQinBusiness.Remoting
{
    public class RemotingClient
    {
        ...
        internal static string SendAndReceive(DataTransferObject dto, bool hasConnectionLost = true)
        {
            ...
            IRunQinServer service = RunQinBusiness.WebServices.RunQinServerProxy.GetRunQinServerInstance();
        ...
        private static string SendAndReceiveRecursive(IRunQinServer service, string dtoString, bool hasConnectionLost = true)
        {
            try
            {
